...
import { handleGoogleEnvTest } from './api/_lib/googleEnvTest.js'
import { handleOpenAiTest } from './api/_lib/openaiTest.js'
  ...
  return {
    ...
    configureServer(server) {
      server.middlewares.use((req, res, next) => {
        ...
        if (pathOnly === '/api/openai-test' && req.method === 'GET') {
        ...
        if (pathOnly === '/api/google-env-test' && req.method === 'GET') {
